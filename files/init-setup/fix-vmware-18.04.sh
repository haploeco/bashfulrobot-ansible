...
read -p "Confirm that the versions on your system match the script --> [ENTER]"
...
read -p "Look at the ...1401... --> [ENTER]"

cat ./fix-vmware-18.04.sh

read -p "Do they match? [Ctrl -C] to fix; [ENTER] to continue..."
